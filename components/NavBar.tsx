...
export default function NavBar() {
    ...
    return (
        <>
            <div className='navbar bg-primary text-primary-content px-4 md:px-8 lg:px-16 border-b border-b-primary-content/20'>
                <div className='w-full flex items-center justify-between'>
                            ...
                            {menus.map((menu, index) => (
                                <li
                                    ...
                                    className={`hover:text-secondary text-lg cursor-pointer ${
                                        pathname === menu.link ? 'text-secondary' : ''
                                    }`}
                                >
                    ...
                    <div className='flex items-center gap-4'>
                        <div className='flex items-stretch'>
                            <button className='btn btn-secondary text-lg rounded-full hidden lg:inline-block'>
                            ...
                            <div className='dropdown dropdown-end block lg:hidden'>
                                ...
                                >
                                    ...
                                    <li>
                                        {' '}
                                        <button className='btn btn-secondary rounded-full w-full mt-4 text-lg'>
                                            <Link href='/contact'>Contact us</Link>
                                        </button>
                                    </li>
                                </ul>
